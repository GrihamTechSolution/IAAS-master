...
@Component({
  selector: 'app-presentation-network',
  templateUrl: './presentation-network.component.html',
  styleUrls: ['./presentation-network.component.scss'],
})
export class PresentationNetworkComponent implements OnInit {
  modalRef: BsModalRef;
